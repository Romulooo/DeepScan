                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          SizedBox(height: 20),
                                          if (double.tryParse(deepfake) != null)
                                            if (double.tryParse(aiGenerated) !=
                                                null)
                                              if (double.parse(aiGenerated) >
                                                      75 &&
                                                  double.parse(deepfake) < 40)
                                                Text(
                                                  "A imagem provavelmente é gerada por IA.",
                                                ),
                                          if (double.parse(deepfake) > 75 &&
                                              double.parse(aiGenerated) < 40)
                                            Text(
                                              "A imagem provavelmente é um deepfake.",
                                            ),
                                          if (double.parse(deepfake) < 40 &&
                                              double.parse(aiGenerated) < 40)
                                            Text(
                                              "A imagem provavelmente não é um deepfake e não é gerada por IA.",
                                            ),
                                          if (double.parse(deepfake) > 75 &&
                                              double.parse(aiGenerated) > 40)
                                            Text(
                                              "A imagem provavelmente é um deepfake ou é gerada por IA.",
                                            ),
                                        ],
                                      ),
                                    ),
